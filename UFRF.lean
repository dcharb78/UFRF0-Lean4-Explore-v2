...
| CircleIntegralBreathing | Specific circle-integral bridge for `1 / (z^13 - 1)` | `sum_circleIntegral_breathingFunction_of_lt_half_infsep_eq_two_pi_I_mul_sum_residueCandidate` |
