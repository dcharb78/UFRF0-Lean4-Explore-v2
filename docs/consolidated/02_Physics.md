...
- **`alpha_inv_bounds_d26`**: `137.03630377587843255920239461 < α⁻¹ < 137.03630377587843255920239475`
- **`alpha_inv_bounds_d27`**: `137.036303775878432559202394616 < α⁻¹ < 137.036303775878432559202394743`
...
- **`phase7OneStepModelResidual_bounds_d26`**: in the separated regime, the one-step residual now also lies in the sharper explicit interval `0.00000093830460995580931173 < residual < 0.00000093830460995580931192`
- **`phase7OneStepModelResidual_bounds_d27`**: in the separated regime, the one-step residual now also lies in the sharper explicit interval `0.000000938304609955809311781 < residual < 0.000000938304609955809311912`
...
- **`alphaPhaseObserverOneStepResidual_bounds_d26`**: equivalently, the observer-indexed one-step residual alias now also satisfies that sharper explicit interval `0.00000093830460995580931173 < residual < 0.00000093830460995580931192`
- **`alphaPhaseObserverOneStepResidual_bounds_d27`**: equivalently, the observer-indexed one-step residual alias now also satisfies that sharper explicit interval `0.000000938304609955809311781 < residual < 0.000000938304609955809311912`
...
- **`alphaCodata2022Gap_bounds_d26`**: the derived `AlphaRunning` gap alias now also lies in the sharper explicit interval `0.00030459887843255920239461 < gap < 0.00030459887843255920239475`
- **`alphaCodata2022Gap_bounds_d27`**: the derived `AlphaRunning` gap alias now also lies in the sharper explicit interval `0.000304598878432559202394616 < gap < 0.000304598878432559202394743`
...
- **`alphaPhaseObserverResidueCheckAbsError_bounds_d26`**: the script-aligned absolute error now also lies in the sharper explicit interval `0.00000093830460995580931173 < error < 0.00000093830460995580931192`
- **`alphaPhaseObserverResidueCheckAbsError_bounds_d27`**: the script-aligned absolute error now also lies in the sharper explicit interval `0.000000938304609955809311781 < error < 0.000000938304609955809311912`
...
twenty-seven-decimal window on the static side; the exposed running prediction
and the exposed `AlphaRunning` gap/residual/error package now both reach
`d27`. Further exposed tightening now requires stronger static-gap transport
beyond `d27` rather than more prediction-only tightening.
